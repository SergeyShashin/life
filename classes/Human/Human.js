...
class Human {
  ...
  kingDomRu = 'животные';
  //подцарство
  subKingDomRu = 'эуметазои';
  //тип
  type = 'хордовые';
  //подтип
  subTypeRu = 'позвоночные';
  //инфратип
  infraType = 'челюстноротые';
  //надкласс
  ...
  subClass = 'звери';
  //инфракласс
  infraClass = 'плацентарные';
  //магнотряд
  magnOrder = 'бореозутерии';
  //надротряд
  superOrder = 'эуархонтоглиры';
  //грандотряд
  grandOrder = 'эуархонты';
  //отряд
  order = 'приматы';
  //подотряд
  subOrder = 'сухоносные приматы';
  //надсемейство
  superFamily = 'человекообразные';
  //семейство
  superFamily = 'гоминиды';
  //род
  genus = 'люди';
  //вид
  kind = 'человек разумный';
