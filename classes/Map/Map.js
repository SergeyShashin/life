...
class Map {
  ...
  //. Пример: человек, млекопитающее, птица, пресмыкающееся, земноводное, рыба, насекомое, паукообразное, моллюск, ракообразное, кораловый полип, животное, цветковое растение, голосеменное, сосудистое споровое, мохобразное, водоросль карсная/зелёная, лишайник, гриб, бурая водоросль,  дерево, куст, цветок, трава, родник, облако, океан, море, река, лужа, здание, мост, опора линии электропередачи, провода, самолёт, вертолёт, ...
