  ...
  objectsMap = [
    {
      ...
      */
      ...
      /**
       * Название объекта. Пример: человек, птица, животное, насекомое, родник, дерево, куст, цветок, трава, здание, мост, опора линии электропередачи, провода, самолёт, вертолёт, ...
       *  @type {string}
       */
      nameObject: null,
