...
class Capsule {
  ...
  //Маршруты.
  routes = [];
  //Варинты выбора точек отправления/назначения. Тоже, что и namesPoints наименования точек в классе CreatorInputs.
  //В будущем сделать, как с людьми и ресурсами PeopleAndResources. Или создавать все datalist в life.js
  coordinates = [
