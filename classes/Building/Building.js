...
class Building {
   ...
   */
  propertiesForInputs = [
    { header: 'наименование здания', id: 'nameBuildingId', name: 'name', class: 'buildingInput', type: 'text', value: 'производственный центр', needDatalist: false },
    { header: 'описание здания', id: 'descriptionBuildingId', name: 'description', class: 'buildingInput', type: 'text', value: 'Для счастливой жизни и производства всего необходимого для жизни.', needDatalist: false },
    { header: 'широта', id: 'latitudeBuildingId', name: 'latitude', class: 'buildingInput', type: 'number', value: 0, needDatalist: false },
    { header: 'долгота', id: 'longitudeBuildingId', name: 'longitude', class: 'buildingInput', type: 'number', value: 0, needDatalist: false },
    { header: 'наименование места', id: 'namePointBuildingId', name: 'namePoint', class: 'buildingInput', type: 'search', value: 'Производственный_центр 8', needDatalist: true },
    { header: 'ширина', id: 'widthBuildingId', name: 'width', class: 'buildingInput', type: 'number', value: 50, needDatalist: false },
    { header: 'длина', id: 'lengthBuildingId', name: 'length', class: 'buildingInput', type: 'number', value: 50, needDatalist: false },
    { header: 'высота', id: 'heighthBuildingId', name: 'height', class: 'buildingInput', type: 'number', value: 100, needDatalist: false },
    { header: 'высота над землёй', id: 'heightAboveGroundBuildingId', name: 'heightAboveGround', class: 'buildingInput', type: 'number', value: 50, needDatalist: false },
    { header: 'высота под землёй', id: 'heightUndergroundBuildingId', name: 'heightUnderground', class: 'buildingInput', type: 'number', value: 50, needDatalist: false },
    { header: 'количество этажей', id: 'numberFloorBuildingId', name: 'numberFloor', class: 'buildingInput', type: 'number', value: 5, needDatalist: false },
    ...
    { header: '3d модель внутри', id: 'model3DFromInsideBuildingId', name: 'model3DFromInside', class: 'buildingInput', type: 'file', value: '', needDatalist: false },
    { header: 'архитектурный проект', id: 'architecturalProjectBuildingId', name: 'architecturalProject', class: 'buildingInput', type: 'file', value: '', needDatalist: false },
